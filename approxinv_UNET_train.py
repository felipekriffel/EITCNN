...
def main(SETTINGS_JSON):
    ...
    print("Number of k approximates:",k_len)
    ...
    unet_model = UNetCompiled(input_size=(128,128,k_len + 2), n_filters=32, n_classes=1,dropout=settings['dropout_prob'])
